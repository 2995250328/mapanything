...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        model/pred_head/adaptor_config=raydirs_depth_pose_confidence_mask \
        model.encoder.uses_torch_hub=false \
        model.pretrained='${root_experiments_dir}/map-anything/training_ablations/a1c_rdp_conf_mask/checkpoint-best.pth' \
        hydra.run.dir='${root_experiments_dir}/map-anything/benchmarking_ablations/dense_'"${num_views}"'_view/a1c_mvs_rdp_conf_mask'
