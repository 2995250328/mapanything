...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        model.pretrained='${root_experiments_dir}/map-anything/training/mapa_curri_4v_6d_48ipg_8g_apache/checkpoint-last.pth' \
        hydra.run.dir='${root_experiments_dir}/map-anything/benchmarking/dense_'"${num_views}"'_view/mapa_4v_apache'
