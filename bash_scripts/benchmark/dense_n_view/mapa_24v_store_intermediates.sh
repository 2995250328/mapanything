...
for combo in "${batch_sizes_and_views[@]}"; do
    ...
    python3 \
        ...
        hydra.run.dir="${root_experiments_dir}/mapanything/benchmarking/dense_${num_views}_view/mapa_24v_store_intermediates"

    echo "Finished $dataset with AA feature capture."
done
